...
2. выбрать метод зашифрования в выпадающем меню, нажмите «Зашифровать» - «Моноалфавитная»;
...
2. выбрать метод расшифрования в выпадающем меню, нажмите «Расшифровать» - «Моноалфавитная»;  
3. ввести значение ключа, нажать «ОК»;
4. Результат появится в новой строке.
