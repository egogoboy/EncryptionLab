...
Ключом шифра является <place_key_description>.
...
При шифровании посимвольной векторной перестановкой <place_method_descrtiption>

<place_method_description_in_the_lines_below>

<lines_to_replace_start>
