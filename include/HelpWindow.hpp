...
2. выбрать метод зашифрования в выпадающем меню, нажмите «Зашифровать» - «<place_your_method>»;
...
2. выбрать метод расшифрования в выпадающем меню, нажмите «Расшифровать» - «<place_your_method>»;  
3. ввести значение ключа, нажать «ОК»;
4. Результат появится в новой строке
