...
2. выбрать метод зашифрования в выпадающем меню, нажмите «Зашифровать» - «Побитовая»;
...
2. выбрать метод расшифрования в выпадающем меню, нажмите «Расшифровать» - «Побитовая»;  
3. ввести значение ключа, нажать «ОК»;
4. Результат появится в новой строке
...
Описание метода побитовой векторной перестановки.

При шифровании побитовой векторной перестановкой <place_method_descrtiption>
